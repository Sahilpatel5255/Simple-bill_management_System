...
def Total():
    ...
    entry_total=Entry(f2,font=('aria',20,'bold'),textvariable=Total_bll,bd=6,width=15,bg="lightgreen")
    entry_total.place(x=20,y=100)
    totalcost=c1+c2+c3+c4+c5+c6+c7
    string_bill="Rs.",str('%.2f' %totalcost)
    Total_bll.set(string_bill)
...
Label(f,font=("Lucida Calligraphy",15,"bold"),text="Pancakes...RS.20/pack",fg="black",bg="lightgreen").place(x=10,y=230)
Label(f,font=("Lucida Calligraphy",15,"bold"),text="Boil Eggs.......RS.15/Egg",fg="black",bg="lightgreen").place(x=10,y=260)
...
lbl_pancakes=Label(f1,font=("aria",20,'bold'),text="Panckaes",width=12,fg="blue4")
lbl_boil_egg=Label(f1,font=("aria",20,'bold'),text="Boil Egg",width=12,fg="blue4")
...
lbl_boil_egg.grid(row=7,column=0)
...
entry_dosa=Entry(f1,font=("aria",20,'bold'),textvariable=dosa,bd=6,width=8,bg="lightyellow")
entry_dosa.grid(row=1,column=1)

entry_cookies=Entry(f1,font=("aria",20,'bold'),textvariable=cookies,bd=6,width=8,bg="lightyellow")
entry_cookies.grid(row=2,column=1)

entry_tea=Entry(f1,font=("aria",20,'bold'),textvariable=Tea,bd=6,width=8,bg="lightyellow")
entry_tea.grid(row=3,column=1)

entry_coffee=Entry(f1,font=("aria",20,'bold'),textvariable=Coffee,bd=6,width=8,bg="lightyellow")
entry_coffee.grid(row=4,column=1)

entry_juice=Entry(f1,font=("aria",20,'bold'),textvariable=juice,bd=6,width=8,bg="lightyellow")
entry_juice.grid(row=5,column=1)

entry_pancakes=Entry(f1,font=("aria",20,'bold'),textvariable=Pancakes,bd=6,width=8,bg="lightyellow")
entry_pancakes.grid(row=6,column=1)

entry_boil_egg=Entry(f1,font=("aria",20,'bold'),textvariable=Eggs,bd=6,width=8,bg="lightyellow")
entry_boil_egg.grid(row=7,column=1)
